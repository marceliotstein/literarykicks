...
To use these stylesheets, rename the files and litmega with the name of your theme.
...
litmega-alpha-default-narrow.css  
...
litmega-alpha-default-normal.css
...
litmega-alpha-default-wide.css
